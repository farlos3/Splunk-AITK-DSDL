...
**The real one behind [6.2 (evade the classifier)](../docs/GUIDE.md#62-attack-the-classifier--evade).**
...
## Poisoning at production scale → [6.3](../docs/GUIDE.md#63-attack-the-classifier--poison)
...
- **Why included:** these show the next step beyond this lab — when an attacker
  can *query* your model ([6.5 API abuse](../docs/GUIDE.md#65-defenses--detections),
